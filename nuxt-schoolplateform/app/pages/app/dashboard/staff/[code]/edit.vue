...
import { useStaffUpdateForm } from "~/composables/staff/useStaffUpdateForm";
...
use1EZSeo({
  ...
  description: `This is the editing page for staff with code ${code}.`,
});

const { update, cancelForm } = useStaffUpdateForm(code);
const {
  meta,
  errors,
  fields,
...
<template>
  <div class="space-y-4 @container">
    <CustomPageTitle>
      <Icon name="lucide:user-round-pen" />
        ...
        <div id="self" :class="sideClasses">
          ...
          <div class="grid gap-2 required-field">
            ...
            <CustomComboboxWithList
              ...
              :options="defaultValues?.options?.genders ?? []"
        ...
        <div id="other" :class="sideClasses">
          ...
          <div class="grid gap-2 required-field">
            ...
            <CustomComboboxWithList
              ...
              :options="defaultValues?.options?.statuses ?? []"
          ...
          <div class="grid gap-2 required-field">
            ...
            <CustomComboboxWithList
              ...
              :options="defaultValues?.options?.positions ?? []"
        ...
        <div id="grade-12" :class="sideClasses">
          ...
          <div class="grid gap-2 required-field">
            ...
            <CustomComboboxWithList
              ...
              :options="defaultValues?.options?.qualificationsBacii ?? []"
          ...
          <div class="grid gap-2 required-field">
            ...
            <CustomComboboxWithList
              ...
              :options="defaultValues?.options?.institutions ?? []"
        ...
        <div id="higher-edu" :class="sideClasses">
          ...
          <div class="grid gap-2">
            ...
            <CustomComboboxWithList
              ...
              :options="defaultValues?.options?.qualifications ?? []"
          ...
          <div class="grid gap-2">
            ...
            <CustomComboboxWithList
              ...
              :options="defaultValues?.options?.subjects ?? []"
        ...
        <div id="first" :class="sideClasses">
          ...
          <div class="grid gap-2 required-field">
            ...
            <CustomComboboxWithList
              ...
              :options="defaultValues?.options?.professionals ?? []"
          ...
          <div class="grid gap-2 required-field">
            ...
            <CustomComboboxWithList
              ...
              :options="defaultValues?.options?.professionalTypes ?? []"
            ...
            >
              <div class="grid gap-2 w-full">
                ...
                <CustomComboboxWithList
                  ...
                  :options="defaultValues?.options?.salaryLevels ?? []"
