import { ClassAcademicIndexRES } from "~/types/class";
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    const res = await $fetch<ClassAcademicIndexRES>(
      `${apiBaseUrl}/admin-secure/classes/get-academics`,
      {
        method: "GET",
        headers: {
    ...
    throw customCreateError(error, "Can't get all academic years!");
  }
});
