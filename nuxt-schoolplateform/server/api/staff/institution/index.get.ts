import { StaffInstitutionIndexResponse } from "~/types/staff";
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    const res = await $fetch<StaffInstitutionIndexResponse>(
      `${apiBaseUrl}/admin-secure/staffs/get-institutions`,
      {
        method: "GET",
        headers: {
    ...
    throw customCreateError(error, "Can't get all institutions!");
  }
});
