import { StaffSalaryLevelIndexResponse } from "~/types/staff";
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    const res = await $fetch<StaffSalaryLevelIndexResponse>(
      `${apiBaseUrl}/admin-secure/staffs/get-salary-levels`,
      {
        method: "GET",
        headers: {
    ...
    throw customCreateError(error, "Can't get all salary levels!");
  }
});
