import { StaffProfessionalIndexResponse } from "~/types/staff";
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    const res = await $fetch<StaffProfessionalIndexResponse>(
      `${apiBaseUrl}/admin-secure/staffs/get-professionals`,
      {
        method: "GET",
        headers: {
    ...
    throw customCreateError(error, "Can't get all professionals!");
  }
});
