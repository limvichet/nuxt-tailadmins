import { StaffProfessionalTypeIndexResponse } from "~/types/staff";
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    const res = await $fetch<StaffProfessionalTypeIndexResponse>(
      `${apiBaseUrl}/admin-secure/staffs/get-professional-types`,
      {
        method: "GET",
        headers: {
    ...
    throw customCreateError(error, "Can't get all professional types!");
  }
});
