import { StaffPositionIndexResponse } from "~/types/staff";
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    const res = await $fetch<StaffPositionIndexResponse>(
      `${apiBaseUrl}/admin-secure/staffs/get-positions`,
      {
        method: "GET",
        headers: {
    ...
    throw customCreateError(error, "Can't get all positions!");
  }
});
