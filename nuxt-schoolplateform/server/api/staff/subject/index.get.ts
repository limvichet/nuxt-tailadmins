import { StaffSubjectIndexResponse } from "~/types/staff";
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    const res = await $fetch<StaffSubjectIndexResponse>(
      `${apiBaseUrl}/admin-secure/staffs/get-subjects`,
      {
        method: "GET",
        headers: {
    ...
    throw customCreateError(error, "Can't get all subjects!");
  }
});
