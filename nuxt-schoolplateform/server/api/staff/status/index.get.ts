import { StaffStatusIndexResponse } from "~/types/staff";
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    const res = await $fetch<StaffStatusIndexResponse>(
      `${apiBaseUrl}/admin-secure/staffs/get-status`,
      {
        method: "GET",
        headers: {
    ...
    throw customCreateError(error, "Can't get all statuses!");
  }
});
